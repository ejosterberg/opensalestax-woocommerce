...
**Status:** v0.3.3. Tested against WordPress 6.6+ / WooCommerce 10.7 / OpenSalesTax engine v0.39. 91 unit tests + an end-to-end integration test on a real WP+WooCom Proxmox VM.
