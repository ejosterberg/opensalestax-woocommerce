...
**Status:** v0.3.1. Tested against WordPress 6.6+ / WooCommerce 10.7 / OpenSalesTax engine v0.36. 74 unit tests + an end-to-end integration test on a real WP+WooCom Proxmox VM.
